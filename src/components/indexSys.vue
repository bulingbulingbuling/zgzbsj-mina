<template>
  <div class="content">
    <div class="landing1">
      <div class="indeximg">
        <img mode="widthFix" :src="`${imgPath}/referral_0624/banner-1.png?v2`" alt="">
      </div>
    </div>
    <div class="video_img">
      <div class="title">
      ...
      <img mode="widthFix" :src="`${imgPath}/referral_0624/langlang_review_video.png`" alt="" @click="playVideo" id="video_sensors" v-show="!videoState">
      <video id="examVideo" class="video" :src="videoUrl" controls v-show="videoState" />
    </div>
    <div class="landing3 text">
      ...
      <div class="content_box">
        <ul>
          <li style="margin: 0">
            <p>AI自动标出需重点练习片段</p>
            <img mode="widthFix" :src="`${imgPath}/referral_0624/play_piano_01.png`" alt="AI自动标出需重点练习片段">
          </li>
          <li>
            <p>弹奏有打分，弹得好不好一目了然</p>
            <img mode="widthFix" :src="`${imgPath}/referral_0624/play_piano_02.png`" alt="弹奏有打分，弹得好不好一目了然">
          </li>
          <li>
            <p>找不到音有提示，提升孩子识谱能力</p>
            <img mode="widthFix" :src="`${imgPath}/referral_0624/play_piano_03.png`" alt="找不到音有提示，提升孩子识谱能力">
          </li>
          <li>
            <p>360度演奏示范，指法手型有参考</p>
            <img mode="widthFix" :src="`${imgPath}/referral_0624/play_piano_04.png`" alt="360度演奏示范，指法手型有参考">
          </li>
        </ul>
      </div>
    </div>
    <div class="landing4 text">
      ...
      <img mode="widthFix" :src="`${imgPath}/referral_0624/operns.png`" alt="曲谱全都有">
    </div>
    <div class="landing6 text">
      ...
      <img mode="widthFix" :src="`${imgPath}/referral_0624/user.png`" alt="使用说明">
    </div>
    ...
    <div class="landing8 text">
      ...
      <img mode="widthFix" :src="`${imgPath}/referral_0624/logos.png`" alt="">
    </div>
...
export default {
  ...
  onReady () {
    this.videoContext = wx.createVideoContext('examVideo')
  },
  methods: {
    playVideo() {
